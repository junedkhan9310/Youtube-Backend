...
//now to get history of user(video history)

const getVideoHistory= asynchadnler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,user[0].watchHistory,"watch history fetched succefully"))
})
